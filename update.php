        ...
        <main class="container p-5">
            ...
            <form action="actions/a_update.php" method="post" enctype="multipart/form-data">
                <table class="table">
                    ...
                    <tr>
                        <th>Latitude</th>
                        <td><input class='form-control' type="float" name="latitude" value=<?php echo $latitude ?> /></td>
                    </tr>
                    <tr>
                        <th>Longitude</th>
                        <td><input class='form-control' type="float" name="longitude" value=<?php echo $longitude ?> /></td>
                    </tr>
                    <tr>
